...
public class createXML_Common_Kepegawaian {
    ...
    public static void buatXML(String[] TARset) {
        ...
        if (TARset.length == 2) {
            if (TARset[0] == "t1") {
                TARset[0] = "Mengajukan Lamaran Pegawai";
            }
            if (TARset[0] == "t2") {
                TARset[0] = "Submit Lamaran";
            }
            if (TARset[0] == "t3") {
                TARset[0] = "Melakukan Tes Pegawai";
            }
            if (TARset[0] == "t4") {
                TARset[0] = "Pengunguman Kelulusan";
            }
            if (TARset[0] == "t5") {
                TARset[0] = "Melakukan Microteaching";
            }
            if (TARset[0] == "t6") {
                TARset[0] = "Pengesahan Pegawai";
            }
            if (TARset[0] == "t7") {
                TARset[0] = "Membuat Pengajuan Pengunduran Diri";
            }
            if (TARset[0] == "t8") {
                TARset[0] = "SK Pengunduran Diri";
            }
            if (TARset[0] == "t9") {
                TARset[0] = "Pemecatan Pegawai";
            }
            //tarset1
            if (TARset[1] == "t1") {
                TARset[1] = "Mengajukan Lamaran Pegawai";
            }
            if (TARset[1] == "t2") {
                TARset[1] = "Submit Lamaran";
            }
            if (TARset[1] == "t3") {
                TARset[1] = "Melakukan Tes Pegawai";
            }
            if (TARset[1] == "t4") {
                TARset[1] = "Pengunguman Kelulusan";
            }
            if (TARset[1] == "t5") {
                TARset[1] = "Melakukan Microteaching";
            }
            if (TARset[1] == "t6") {
                TARset[1] = "Pengesahan Pegawai";
            }
            if (TARset[1] == "t7") {
                TARset[1] = "Membuat Pengajuan Pengunduran Diri";
            }
            if (TARset[1] == "t8") {
                TARset[1] = "SK Pengunduran Diri";
            }
            if (TARset[1] == "t9") {
                TARset[1] = "Pemecatan Pegawai";
            }
        }
        ...
        if (TARset.length == 3) {
            ...
            //tarset3
            if (TARset[2] == "t1") {
                TARset[2] = "Mengajukan Lamaran Pegawai";
            }
            if (TARset[2] == "t2") {
                TARset[2] = "Submit Lamaran";
            }
            if (TARset[2] == "t3") {
                TARset[2] = "Melakukan Tes Pegawai";
            }
            if (TARset[2] == "t4") {
                TARset[2] = "Pengunguman Kelulusan";
            }
            if (TARset[2] == "t5") {
                TARset[2] = "Melakukan Microteaching";
            }
            if (TARset[2] == "t6") {
                TARset[2] = "Pengesahan Pegawai";
            }
            if (TARset[2] == "t7") {
                TARset[2] = "Membuat Pengajuan Pengunduran Diri";
            }
            if (TARset[2] == "t8") {
                TARset[2] = "SK Pengunduran Diri";
            }
            if (TARset[2] == "t9") {
                TARset[2] = "Pemecatan Pegawai";
            }
        }
        ...
        try {
            ...
            StreamResult result
                    = new StreamResult(new File("E:/MODEL/Model Baru/Common_Kepegawaian.pnml"));
