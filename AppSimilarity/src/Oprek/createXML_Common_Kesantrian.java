...
public class createXML_Common_Kesantrian {
    ...
    public static void buatXML(String[] TARset) {
        ...
        if (TARset.length == 2) {
            if (TARset[0] == "t1") {
                TARset[0] = "Kegiatan agama pagi";
            }
            if (TARset[0] == "t2") {
                TARset[0] = "Absensi piket harian";
            }
            if (TARset[0] == "t3") {
                TARset[0] = "Penetuan ustadz tahsin";
            }
            if (TARset[0] == "t4") {
                TARset[0] = "Pendataan santri kuliah";
            }
            if (TARset[0] == "t5") {
                TARset[0] = "Kegiatan sore harian";
            }
            if (TARset[0] == "t6") {
                TARset[0] = "Aktivitas diniyah";
            }
            if (TARset[0] == "t7") {
                TARset[0] = "Penentuan pengajar diniyah";
            }
            if (TARset[0] == "t8") {
                TARset[0] = "Perencanaan kegiatan santri harian";
            }
            if (TARset[0] == "t9") {
                TARset[0] = "Absensi santri pondok";
            }
            //tarset1
            if (TARset[1] == "t1") {
                TARset[1] = "Kegiatan agama pagi";
            }
            if (TARset[1] == "t2") {
                TARset[1] = "Absensi piket harian";
            }
            if (TARset[1] == "t3") {
                TARset[1] = "Penetuan ustadz tahsin";
            }
            if (TARset[1] == "t4") {
                TARset[1] = "Pendataan santri kuliah";
            }
            if (TARset[1] == "t5") {
                TARset[1] = "Kegiatan sore harian";
            }
            if (TARset[1] == "t6") {
                TARset[1] = "Aktivitas diniyah";
            }
            if (TARset[1] == "t7") {
                TARset[1] = "Penentuan pengajar diniyah";
            }
            if (TARset[1] == "t8") {
                TARset[1] = "Perencanaan kegiatan santri harian";
            }
            if (TARset[1] == "t9") {
                TARset[1] = "Absensi santri pondok";
            }
        }
        ...
        if (TARset.length == 3) {
            ...
            //tarset3
            if (TARset[2] == "t1") {
                TARset[2] = "Kegiatan agama pagi";
            }
            if (TARset[2] == "t2") {
                TARset[2] = "Absensi piket harian";
            }
            if (TARset[2] == "t3") {
                TARset[2] = "Penetuan ustadz tahsin";
            }
            if (TARset[2] == "t4") {
                TARset[2] = "Pendataan santri kuliah";
            }
            if (TARset[2] == "t5") {
                TARset[2] = "Kegiatan sore harian";
            }
            if (TARset[2] == "t6") {
                TARset[2] = "Aktivitas diniyah";
            }
            if (TARset[2] == "t7") {
                TARset[2] = "Penentuan pengajar diniyah";
            }
            if (TARset[2] == "t8") {
                TARset[2] = "Perencanaan kegiatan santri harian";
            }
            if (TARset[2] == "t9") {
                TARset[2] = "Absensi santri pondok";
            }
        }
        //tarset3
        if (TARset.length == 4) {
            ...
            //tarset3
            if (TARset[3] == "t1") {
                TARset[3] = "Kegiatan agama pagi";
            }
            if (TARset[3] == "t2") {
                TARset[3] = "Absensi piket harian";
            }
            if (TARset[3] == "t3") {
                TARset[3] = "Penetuan ustadz tahsin";
            }
            if (TARset[3] == "t4") {
                TARset[3] = "Pendataan santri kuliah";
            }
            if (TARset[3] == "t5") {
                TARset[3] = "Kegiatan sore harian";
            }
            if (TARset[3] == "t6") {
                TARset[3] = "Aktivitas diniyah";
            }
            if (TARset[3] == "t7") {
                TARset[3] = "Penentuan pengajar diniyah";
            }
            if (TARset[3] == "t8") {
                TARset[3] = "Perencanaan kegiatan santri harian";
            }
            if (TARset[3] == "t9") {
                TARset[3] = "Absensi santri pondok";
            }
        }
        ...
        try {
            ...
            StreamResult result
                    = new StreamResult(new File("E:/MODEL/Model Baru/Common_Kesantrian.pnml"));
    ...
    public static void main(String argv[]) {
        //String tar[] = {"t1", "t2","t3","t4","t5","t6","t7"};
        String tar[] = {"t1", "t3", "t2"};
