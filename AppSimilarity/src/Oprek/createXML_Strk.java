    ...
    public static void buatXML(String[] TARset) {
        try {
            ...
            if (TARset.length == 1) {
                ...
                place("selesai", doc, net, "240", "150", "240", "110");
                arc("a1", doc, net, TARset[0], "selesai");
            }
            
            else if (TARset.length == 2) {
                transisi(TARset[0], doc, net, "140", "150", "140", "110");
                place("mulai", doc, net, "40", "150", "40", "110");
                arc("a1", doc, net, "mulai", TARset[0]);
            ...
            StreamResult result
                    = new StreamResult(new File("F:/Zmmm/Common_.pnml"));
