...
public class Clusteringfix {
    ...
    public static void main(String[] args) {
        Clusteringfix c = new Clusteringfix();
        String[] irisan = {"p3", "p2", "p1", "t2", "t1"};
        String[] iris = {"p3", "p2"};
//        c.inputclus(0.5, irisan, iris);
//        c.inputclus(0.6, irisan, iris);
//        c.inputclus(0.62, irisan, iris);
//        c.inputclus(0.65, irisan, iris);
//        c.inputclus(0.7, irisan, iris);

        c.tampilclus(0.6, 0.69);
    }

    public void tampilclus(double treshol, double bts) {
