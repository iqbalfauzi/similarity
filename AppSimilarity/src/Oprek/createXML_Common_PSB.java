...
public class createXML_Common_PSB {
    ...
    public static void buatXML(String[] TARset) {
        ...
        if (TARset.length == 2) {
            if (TARset[0] == "t1") {
                TARset[0] = "mendaftar di pondok pesantren";
            }
            if (TARset[0] == "t2") {
                TARset[0] = "mendapatkan bukti tanda terima pondok pesantren";
            }
            if (TARset[0] == "t3") {
                TARset[0] = "mengambil dan mengisi formulir data pendaftaran";
            }
            if (TARset[0] == "t4") {
                TARset[0] = "menyerahkan kembali formulir dengan melampirkan kartu bukti terima pondok";
            }
            if (TARset[0] == "t5") {
                TARset[0] = "entri data pendaftaran";
            }
            if (TARset[0] == "t6") {
                TARset[0] = "mencetak tanda bukti pendaftaran";
            }
            if (TARset[0] == "t7") {
                TARset[0] = "melakukan pembayaran ke administrasi keuangan";
            }
            if (TARset[0] == "t8") {
                TARset[0] = "masa orientasi peserta didik baru";
            }
            if (TARset[0] == "t9") {
                TARset[0] = "menyerahkan kembali formulir kepada panitia dengan melampirkan berkas pendaftaran lainnya";
            }
            //tarset1
            if (TARset[1] == "t1") {
                TARset[1] = "mendaftar di pondok pesantren";
            }
            if (TARset[1] == "t2") {
                TARset[1] = "mendapatkan bukti tanda terima pondok pesantren";
            }
            if (TARset[1] == "t3") {
                TARset[1] = "mengambil dan mengisi formulir data pendaftaran";
            }
            if (TARset[1] == "t4") {
                TARset[1] = "menyerahkan kembali formulir dengan melampirkan kartu bukti terima pondok";
            }
            if (TARset[1] == "t5") {
                TARset[1] = "entri data pendaftaran";
            }
            if (TARset[1] == "t6") {
                TARset[1] = "mencetak tanda bukti pendaftaran";
            }
            if (TARset[1] == "t7") {
                TARset[1] = "melakukan pembayaran ke administrasi keuangan";
            }
            if (TARset[1] == "t8") {
                TARset[1] = "masa orientasi peserta didik baru";
            }
            if (TARset[1] == "t9") {
                TARset[1] = "menyerahkan kembali formulir kepada panitia dengan melampirkan berkas pendaftaran lainnya";
            }
        }
        ...
        if (TARset.length == 3) {
            ...
            //tarset3
            if (TARset[2] == "t1") {
                TARset[2] = "mendaftar di pondok pesantren";
            }
            if (TARset[2] == "t2") {
                TARset[2] = "mendapatkan bukti tanda terima pondok pesantren";
            }
            if (TARset[2] == "t3") {
                TARset[2] = "mengambil dan mengisi formulir data pendaftaran";
            }
            if (TARset[2] == "t4") {
                TARset[2] = "menyerahkan kembali formulir dengan melampirkan kartu bukti terima pondok";
            }
            if (TARset[2] == "t5") {
                TARset[2] = "entri data pendaftaran";
            }
            if (TARset[2] == "t6") {
                TARset[2] = "mencetak tanda bukti pendaftaran";
            }
            if (TARset[2] == "t7") {
                TARset[2] = "melakukan pembayaran ke administrasi keuangan";
            }
            if (TARset[2] == "t8") {
                TARset[2] = "masa orientasi peserta didik baru";
            }
            if (TARset[2] == "t9") {
                TARset[2] = "menyerahkan kembali formulir kepada panitia dengan melampirkan berkas pendaftaran lainnya";
            }
        }
        //tarset3
        if (TARset.length == 4) {
            ...
            //tarset3
            if (TARset[3] == "t1") {
                TARset[3] = "mendaftar di pondok pesantren";
            }
            if (TARset[3] == "t2") {
                TARset[3] = "mendapatkan bukti tanda terima pondok pesantren";
            }
            if (TARset[3] == "t3") {
                TARset[3] = "mengambil dan mengisi formulir data pendaftaran";
            }
            if (TARset[3] == "t4") {
                TARset[3] = "menyerahkan kembali formulir dengan melampirkan kartu bukti terima pondok";
            }
            if (TARset[3] == "t5") {
                TARset[3] = "entri data pendaftaran";
            }
            if (TARset[3] == "t6") {
                TARset[3] = "mencetak tanda bukti pendaftaran";
            }
            if (TARset[3] == "t7") {
                TARset[3] = "melakukan pembayaran ke administrasi keuangan";
            }
            if (TARset[3] == "t8") {
                TARset[3] = "masa orientasi peserta didik baru";
            }
            if (TARset[3] == "t9") {
                TARset[3] = "menyerahkan kembali formulir kepada panitia dengan melampirkan berkas pendaftaran lainnya";
            }
        }
        if (TARset.length == 5) {
            if (TARset[0] == "t1") {
            ...
            //tarset4
            if (TARset[4] == "t1") {
                TARset[4] = "mendaftar di pondok pesantren";
            }
            if (TARset[4] == "t2") {
                TARset[4] = "mendapatkan bukti tanda terima pondok pesantren";
            }
            if (TARset[4] == "t3") {
                TARset[4] = "mengambil dan mengisi formulir data pendaftaran";
            }
            if (TARset[4] == "t4") {
                TARset[4] = "menyerahkan kembali formulir dengan melampirkan kartu bukti terima pondok";
            }
            if (TARset[4] == "t5") {
                TARset[4] = "entri data pendaftaran";
            }
            if (TARset[4] == "t6") {
                TARset[4] = "mencetak tanda bukti pendaftaran";
            }
            if (TARset[4] == "t7") {
                TARset[4] = "melakukan pembayaran ke administrasi keuangan";
            }
            if (TARset[4] == "t8") {
                TARset[4] = "masa orientasi peserta didik baru";
            }
            if (TARset[4] == "t9") {
                TARset[4] = "menyerahkan kembali formulir kepada panitia dengan melampirkan berkas pendaftaran lainnya";
            }
        }
        ...
        try {
            ...
            StreamResult result
                    = new StreamResult(new File("E:/MODEL/Model Baru/Common_PSB.pnml"));
    ...
    public static void main(String argv[]) {
        String tar[] = {"t1", "t2","t3","t4"};
        //String tar[]={"mengambil dan mengisi formulir data pendaftaran", "entri data pendaftaran", "mencetak tanda bukti pendaftaran", "masa orientasi peserta didik baru"};
